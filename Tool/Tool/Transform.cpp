...
void CTransform::Set_Rotate(_vec3 vRot)
{
	m_vRotate = vRot;
	Rotation_X(D3DXToRadian(m_vRotate.x));
	Rotation_Y(D3DXToRadian(m_vRotate.y));
	Rotation_Z(D3DXToRadian(m_vRotate.z));
}
