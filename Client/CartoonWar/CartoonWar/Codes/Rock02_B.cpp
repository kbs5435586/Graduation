...
CRock02_B::CRock02_B(const CRock02_B& rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock02_B::Ready_Prototype()
{
	return S_OK;
}

HRESULT CRock02_B::Ready_GameObject(void* pArg)
{
...
_int CRock02_B::Update_GameObject(const _float& fTimeDelta)
{
	return _int();
}

_int CRock02_B::LastUpdate_GameObject(const _float& fTimeDelta)
{
...
void CRock02_B::Render_GameObject()
{
...
HRESULT CRock02_B::CreateInputLayout()
{
...
CRock02_B* CRock02_B::Create()
{
	CRock02_B* pInstance = new CRock02_B();

	if (FAILED(pInstance->Ready_Prototype()))
	{
		MessageBox(0, L"CRock02_B Created Failed", L"System Error", MB_OK);
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CRock02_B::Clone_GameObject(void* pArg, const _uint& iIdx)
{
	CRock02_B* pInstance = new CRock02_B(*this);
...
HRESULT CRock02_B::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CMesh*)pManagement->Clone_Component((_uint)SCENEID::SCENE_STATIC, L"Component_Static_Rock02_B");
