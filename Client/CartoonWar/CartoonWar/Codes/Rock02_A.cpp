...
CRock02_A::CRock02_A(const CRock02_A& rhs)
{
}

HRESULT CRock02_A::Ready_Prototype()
{
	return S_OK;
}

HRESULT CRock02_A::Ready_GameObject(void* pArg)
{
...
_int CRock02_A::Update_GameObject(const _float& fTimeDelta)
{
	return _int();
}

_int CRock02_A::LastUpdate_GameObject(const _float& fTimeDelta)
{
...
void CRock02_A::Render_GameObject()
{
...
HRESULT CRock02_A::CreateInputLayout()
{
...
CRock02_A* CRock02_A::Create()
{
	CRock02_A* pInstance = new CRock02_A();

	if (FAILED(pInstance->Ready_Prototype()))
	{
		MessageBox(0, L"CRock02_A Created Failed", L"System Error", MB_OK);
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CRock02_A::Clone_GameObject(void* pArg, const _uint& iIdx)
{
	CRock02_A* pInstance = new CRock02_A(*this);
...
HRESULT CRock02_A::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CMesh*)pManagement->Clone_Component((_uint)SCENEID::SCENE_STATIC, L"Component_Static_Rock02_A");
