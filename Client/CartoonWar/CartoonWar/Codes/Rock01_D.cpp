...
{
	CRock01_D* pInstance = new CRock01_D();

	if (FAILED(pInstance->Ready_Prototype()))
	{
		MessageBox(0, L"CRock01_D Created Failed", L"System Error", MB_OK);
...
{
	CRock01_D* pInstance = new CRock01_D(*this);
...
HRESULT CRock01_D::Ready_Component()
{
	...
	m_pMeshCom = (CMesh*)pManagement->Clone_Component((_uint)SCENEID::SCENE_STATIC, L"Component_Static_Rock01_D");
