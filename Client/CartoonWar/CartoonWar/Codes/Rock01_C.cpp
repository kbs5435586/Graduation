...
{
	CRock01_C* pInstance = new CRock01_C();

	if (FAILED(pInstance->Ready_Prototype()))
	{
		MessageBox(0, L"CRock01_C Created Failed", L"System Error", MB_OK);
...
{
	CRock01_C* pInstance = new CRock01_C(*this);
...
HRESULT CRock01_C::Ready_Component()
{
	...
	m_pMeshCom = (CMesh*)pManagement->Clone_Component((_uint)SCENEID::SCENE_STATIC, L"Component_Static_Rock01_C");
