...
CRock03::CRock03(const CRock03& rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock03::Ready_Prototype()
{
	return S_OK;
}

HRESULT CRock03::Ready_GameObject(void* pArg)
{
...
_int CRock03::Update_GameObject(const _float& fTimeDelta)
{
	return _int();
}

_int CRock03::LastUpdate_GameObject(const _float& fTimeDelta)
{
...
void CRock03::Render_GameObject()
{
...
HRESULT CRock03::CreateInputLayout()
{
...
CRock03* CRock03::Create()
{
	CRock03* pInstance = new CRock03();

	if (FAILED(pInstance->Ready_Prototype()))
	{
		MessageBox(0, L"CRock03 Created Failed", L"System Error", MB_OK);
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CRock03::Clone_GameObject(void* pArg, const _uint& iIdx)
{
	CRock03* pInstance = new CRock03(*this);
...
HRESULT CRock03::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CMesh*)pManagement->Clone_Component((_uint)SCENEID::SCENE_STATIC, L"Component_Static_Rock03");
