...
CWeapon04::CWeapon04(const CWeapon04& rhs)
	: CWeapon(rhs)
{
}

HRESULT CWeapon04::Ready_Prototype()
{
	return S_OK;
}

HRESULT CWeapon04::Ready_GameObject(void* pArg)
{
...
_int CWeapon04::Update_GameObject(const _float& fTimeDelta)
{
...
_int CWeapon04::LastUpdate_GameObject(const _float& fTimeDelta)
{
...
HRESULT CWeapon04::CreateInputLayout()
{
...
CWeapon04* CWeapon04::Create()
{
	CWeapon04* pInstance = new CWeapon04();

	if (FAILED(pInstance->Ready_Prototype()))
	{
		MessageBox(0, L"CWeapon04 Created Failed", L"System Error", MB_OK);
...
HRESULT CWeapon04::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CMesh*)pManagement->Clone_Component((_uint)SCENEID::SCENE_STATIC, L"Component_Mesh_Weapon4");
