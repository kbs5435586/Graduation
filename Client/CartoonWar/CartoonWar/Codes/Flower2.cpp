...
CFlower2::CFlower2(const CFlower2& rhs)
	: CGameObject(rhs)
{
}

HRESULT CFlower2::Ready_Prototype()
{
	return S_OK;
}

HRESULT CFlower2::Ready_GameObject(void* pArg)
{
...
_int CFlower2::Update_GameObject(const _float& fTimeDelta)
{
	return _int();
}

_int CFlower2::LastUpdate_GameObject(const _float& fTimeDelta)
{
...
void CFlower2::Render_GameObject()
{
...
HRESULT CFlower2::CreateInputLayout()
{
...
CFlower2* CFlower2::Create()
{
	CFlower2* pInstance = new CFlower2();

	if (FAILED(pInstance->Ready_Prototype()))
	{
		MessageBox(0, L"CFlower2 Created Failed", L"System Error", MB_OK);
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CFlower2::Clone_GameObject(void* pArg, const _uint& iIdx)
{
	CFlower2* pInstance = new CFlower2(*this);
...
HRESULT CFlower2::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CMesh*)pManagement->Clone_Component((_uint)SCENEID::SCENE_STATIC, L"Component_Static_rpg_Flower3");
