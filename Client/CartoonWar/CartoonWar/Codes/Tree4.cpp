...
CTree4::CTree4(const CTree4& rhs)
	: CGameObject(rhs)
{
}

HRESULT CTree4::Ready_Prototype()
{
	return S_OK;
}

HRESULT CTree4::Ready_GameObject(void* pArg)
{
...
_int CTree4::Update_GameObject(const _float& fTimeDelta)
{
	return _int();
}

_int CTree4::LastUpdate_GameObject(const _float& fTimeDelta)
{
...
HRESULT CTree4::CreateInputLayout()
{
...
CTree4* CTree4::Create()
{
	CTree4* pInstance = new CTree4();

	if (FAILED(pInstance->Ready_Prototype()))
	{
		MessageBox(0, L"CTree4 Created Failed", L"System Error", MB_OK);
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CTree4::Clone_GameObject(void* pArg, const _uint& iIdx)
{
	CTree4* pInstance = new CTree4(*this);
...
HRESULT CTree4::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
