...
CWeapon03::CWeapon03(const CWeapon03& rhs)
	: CWeapon(rhs)
{
}

HRESULT CWeapon03::Ready_Prototype()
{
	return S_OK;
}

HRESULT CWeapon03::Ready_GameObject(void* pArg)
{
...
_int CWeapon03::Update_GameObject(const _float& fTimeDelta)
{
...
_int CWeapon03::LastUpdate_GameObject(const _float& fTimeDelta)
{
...
void CWeapon03::Render_GameObject()
{
...
HRESULT CWeapon03::CreateInputLayout()
{
...
CWeapon03* CWeapon03::Create()
{
	CWeapon03* pInstance = new CWeapon03();

	if (FAILED(pInstance->Ready_Prototype()))
	{
		MessageBox(0, L"CWeapon03 Created Failed", L"System Error", MB_OK);
...
HRESULT CWeapon03::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
