...
CRock5::CRock5(const CRock5& rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock5::Ready_Prototype()
{
	return S_OK;
}

HRESULT CRock5::Ready_GameObject(void* pArg)
{
...
_int CRock5::Update_GameObject(const _float& fTimeDelta)
{
	return _int();
}

_int CRock5::LastUpdate_GameObject(const _float& fTimeDelta)
{
...
HRESULT CRock5::CreateInputLayout()
{
...
CRock5* CRock5::Create()
{
	CRock5* pInstance = new CRock5();

	if (FAILED(pInstance->Ready_Prototype()))
	{
		MessageBox(0, L"CRock5 Created Failed", L"System Error", MB_OK);
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CRock5::Clone_GameObject(void* pArg, const _uint& iIdx)
{
...
HRESULT CRock5::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
