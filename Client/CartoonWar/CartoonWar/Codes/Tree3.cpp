...
CTree3::CTree3(const CTree3& rhs)
	: CGameObject(rhs)
{
}

HRESULT CTree3::Ready_Prototype()
{
	return S_OK;
}

HRESULT CTree3::Ready_GameObject(void* pArg)
{
...
_int CTree3::Update_GameObject(const _float& fTimeDelta)
{
	return _int();
}

_int CTree3::LastUpdate_GameObject(const _float& fTimeDelta)
{
...
HRESULT CTree3::CreateInputLayout()
{
...
CTree3* CTree3::Create()
{
	CTree3* pInstance = new CTree3();

	if (FAILED(pInstance->Ready_Prototype()))
	{
		MessageBox(0, L"CTree3 Created Failed", L"System Error", MB_OK);
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CTree3::Clone_GameObject(void* pArg, const _uint& iIdx)
{
	CTree3* pInstance = new CTree3(*this);
...
HRESULT CTree3::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
