...
CCloud0::CCloud0(const CCloud0& rhs)
	: CGameObject(rhs)
{
}

HRESULT CCloud0::Ready_Prototype()
{
	return S_OK;
}

HRESULT CCloud0::Ready_GameObject(void* pArg)
{
...
_int CCloud0::Update_GameObject(const _float& fTimeDelta)
{
	return _int();
}

_int CCloud0::LastUpdate_GameObject(const _float& fTimeDelta)
{
...
void CCloud0::Render_GameObject()
{
...
HRESULT CCloud0::CreateInputLayout()
{
...
CCloud0* CCloud0::Create()
{
	CCloud0* pInstance = new CCloud0();

	if (FAILED(pInstance->Ready_Prototype()))
	{
		MessageBox(0, L"CCloud0 Created Failed", L"System Error", MB_OK);
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CCloud0::Clone_GameObject(void* pArg, const _uint& iIdx)
{
	CCloud0* pInstance = new CCloud0(*this);
...
HRESULT CCloud0::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CMesh*)pManagement->Clone_Component((_uint)SCENEID::SCENE_STATIC, L"Component_Static_rpg_Cloud1");
