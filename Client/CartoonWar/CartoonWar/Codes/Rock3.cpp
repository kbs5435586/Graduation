...
CRock3::CRock3(const CRock3& rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock3::Ready_Prototype()
{
	return S_OK;
}

HRESULT CRock3::Ready_GameObject(void* pArg)
{
...
_int CRock3::Update_GameObject(const _float& fTimeDelta)
{
	return _int();
}

_int CRock3::LastUpdate_GameObject(const _float& fTimeDelta)
{
...
HRESULT CRock3::CreateInputLayout()
{
...
CRock3* CRock3::Create()
{
	CRock3* pInstance = new CRock3();

	if (FAILED(pInstance->Ready_Prototype()))
	{
		MessageBox(0, L"CRock3 Created Failed", L"System Error", MB_OK);
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CRock3::Clone_GameObject(void* pArg, const _uint& iIdx)
{
	CRock3* pInstance = new CRock3(*this);
...
HRESULT CRock3::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CMesh*)pManagement->Clone_Component((_uint)SCENEID::SCENE_STATIC, L"Component_Static_rpg_Rock4");
