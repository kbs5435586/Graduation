...
HRESULT CRTTMananger::Ready_RTTMananger()
{
	...
	//	// SwapChain MRT
	//	CMRT* pMRT = CMRT::Create(2, arrRT, m_pDsBackTex);
	//	m_vecMRT.push_back(pMRT);
	...
	//		arrRT[0].pRtt = CRTT::Create(L"DiffuseTargetTex"
	//			, (UINT)WINCX, (UINT)WINCY, DXGI_FORMAT_R8G8B8A8_UNORM, CD3DX12_HEAP_PROPERTIES(D3D12_HEAP_TYPE_DEFAULT), D3D12_HEAP_FLAG_NONE
	//			, D3D12_RESOURCE_FLAG_ALLOW_RENDER_TARGET, 1, arrRT[0].vClear_Color);
	//		if (arrRT[0].pRtt == nullptr)
	//			return E_FAIL;
	...
	//		arrRT[1].pRtt = CRTT::Create(L"NormalTargetTex"
	//			, (UINT)WINCX, (UINT)WINCY, DXGI_FORMAT_R32G32B32A32_FLOAT, CD3DX12_HEAP_PROPERTIES(D3D12_HEAP_TYPE_DEFAULT), D3D12_HEAP_FLAG_NONE
	//			, D3D12_RESOURCE_FLAG_ALLOW_RENDER_TARGET, 1, arrRT[1].vClear_Color);
	//		if (arrRT[1].pRtt == nullptr)
	//			return E_FAIL;
	...
	//		arrRT[2].pRtt = CRTT::Create(L"PositionTargetTex"
	//			, (UINT)WINCX, (UINT)WINCY, DXGI_FORMAT_R32G32B32A32_FLOAT, CD3DX12_HEAP_PROPERTIES(D3D12_HEAP_TYPE_DEFAULT), D3D12_HEAP_FLAG_NONE
	//			, D3D12_RESOURCE_FLAG_ALLOW_RENDER_TARGET, 1, arrRT[2].vClear_Color);
	//		if (arrRT[2].pRtt == nullptr)
	//			return E_FAIL;
	...
	//		arrRT[3].pRtt = CRTT::Create(L"PositionTargetTex"
	//			, (UINT)WINCX, (UINT)WINCY, DXGI_FORMAT_R32G32B32A32_FLOAT, CD3DX12_HEAP_PROPERTIES(D3D12_HEAP_TYPE_DEFAULT), D3D12_HEAP_FLAG_NONE
	//			, D3D12_RESOURCE_FLAG_ALLOW_RENDER_TARGET, 1, arrRT[3].vClear_Color);
	//		if (arrRT[3].pRtt == nullptr)
	//			return E_FAIL;
	...
	//		arrRT[4].pRtt = CRTT::Create(L"PositionTargetTex"
	//			, (UINT)WINCX, (UINT)WINCY, DXGI_FORMAT_R32G32B32A32_FLOAT, CD3DX12_HEAP_PROPERTIES(D3D12_HEAP_TYPE_DEFAULT), D3D12_HEAP_FLAG_NONE
	//			, D3D12_RESOURCE_FLAG_ALLOW_RENDER_TARGET, 1, arrRT[4].vClear_Color);
	//		if (arrRT[4].pRtt == nullptr)
	//			return E_FAIL;
	...
	//		arrRT[5].pRtt = CRTT::Create(L"DiffuseTargetTex"
	//			, (UINT)WINCX, (UINT)WINCY, DXGI_FORMAT_R32G32B32A32_FLOAT, CD3DX12_HEAP_PROPERTIES(D3D12_HEAP_TYPE_DEFAULT), D3D12_HEAP_FLAG_NONE
	//			, D3D12_RESOURCE_FLAG_ALLOW_RENDER_TARGET, 1, arrRT[5].vClear_Color);
	//		if (arrRT[5].pRtt == nullptr)
	//			return E_FAIL;

	//		CMRT* pMRT = CMRT::Create(6, arrRT, m_pDsBackTex);
	//		m_vecMRT.push_back(pMRT);
