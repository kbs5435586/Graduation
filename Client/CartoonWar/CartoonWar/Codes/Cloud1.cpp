...
HRESULT CCloud1::Ready_Prototype()
{
	return S_OK;
}

HRESULT CCloud1::Ready_GameObject(void* pArg)
{
...
_int CCloud1::Update_GameObject(const _float& fTimeDelta)
{
	return _int();
}

_int CCloud1::LastUpdate_GameObject(const _float& fTimeDelta)
{
...
void CCloud1::Render_GameObject()
{
...
HRESULT CCloud1::CreateInputLayout()
{
...
CCloud1* CCloud1::Create()
{
	CCloud1* pInstance = new CCloud1();

	if (FAILED(pInstance->Ready_Prototype()))
	{
		MessageBox(0, L"CCloud1 Created Failed", L"System Error", MB_OK);
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CCloud1::Clone_GameObject(void* pArg, const _uint& iIdx)
{
	CCloud1* pInstance = new CCloud1(*this);
...
HRESULT CCloud1::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CMesh*)pManagement->Clone_Component((_uint)SCENEID::SCENE_STATIC, L"Component_Static_rpg_Cloud2");
