...
HRESULT CScene_Stage::Ready_Prototype_GameObject(CManagement* pManagement)
{
	...
	if (FAILED(pManagement->Add_Prototype_GameObject(L"GameObject_FireWall", CFireWall::Create())))
		return E_FAIL;
	if (FAILED(pManagement->Add_Prototype_GameObject(L"GameObject_Range", CRange::Create())))
		return E_FAIL;
...
//	//	return E_FAIL;
//
//	//XMFLOAT2 fTemp = { 50, 50 };
//	//if (FAILED(CManagement::GetInstance()->Add_GameObjectToLayer(L"GameObject_Teleport", (_uint)SCENEID::SCENE_STAGE, pLayerTag, nullptr, (void*)&fTemp)))
//	//	return E_FAIL;
//	return S_OK;
//}
...
HRESULT CScene_Stage::Ready_Layer_Inventory(const _tchar* pLayerTag, CManagement* pManagement)
{
	...
	if (FAILED(pManagement->Add_GameObjectToLayer(L"GameObject_Player_Inventory", (_uint)SCENEID::SCENE_STAGE, pLayerTag, nullptr, (void*)&tInfo)))
		return E_FAIL;

	tInfo = { SPECIES::SPECIES_UNDEAD, COLOR::COLOR_RED };
