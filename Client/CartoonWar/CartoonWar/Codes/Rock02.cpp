...
CRock02::CRock02(const CRock02& rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock02::Ready_Prototype()
{
	return S_OK;
}

HRESULT CRock02::Ready_GameObject(void* pArg)
{
...
_int CRock02::Update_GameObject(const _float& fTimeDelta)
{
	return _int();
}

_int CRock02::LastUpdate_GameObject(const _float& fTimeDelta)
{
...
void CRock02::Render_GameObject()
{
...
HRESULT CRock02::CreateInputLayout()
{
...
CRock02* CRock02::Create()
{
	CRock02* pInstance = new CRock02();

	if (FAILED(pInstance->Ready_Prototype()))
	{
		MessageBox(0, L"CRock02 Created Failed", L"System Error", MB_OK);
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CRock02::Clone_GameObject(void* pArg, const _uint& iIdx)
{
	CRock02* pInstance = new CRock02(*this);
...
HRESULT CRock02::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
