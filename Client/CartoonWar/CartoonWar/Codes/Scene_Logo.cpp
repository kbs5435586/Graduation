...
HRESULT CScene_Logo::Ready_Add_Prototype_Texture(CManagement* pManagement)
{
	...
	//PNGJPG
	{
		...
		if (FAILED(pManagement->Add_Prototype_Component((_uint)SCENEID::SCENE_STATIC, L"Component_Texture_CartoonSmoke",
			...
			return E_FAIL;
		if (FAILED(pManagement->Add_Prototype_Component((_uint)SCENEID::SCENE_STATIC, L"Component_Texture_SkyBox_PNG",
			CTexture::Create(L"../Bin/Resource/Texture/SkyBox/SkyBox%d.png", 1, TEXTURE_TYPE::TEXTURE_TYPE_PNG_JPG, true))))
			return E_FAIL;
	}
