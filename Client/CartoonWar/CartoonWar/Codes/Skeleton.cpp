...
HRESULT CSkeleton::CreateInputLayout()
{
...
CSkeleton* CSkeleton::Create()
{
	...
	{
		MessageBox(0, L"CSkeleton Created Failed", L"System Error", MB_OK);
...
HRESULT CSkeleton::Ready_Component()
{
	...
	m_pMeshCom = (CMesh*)pManagement->Clone_Component((_uint)SCENEID::SCENE_STATIC, L"Component_Mesh_Skeleton");
