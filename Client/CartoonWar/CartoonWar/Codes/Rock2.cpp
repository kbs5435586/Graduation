...
CRock2::CRock2(const CRock2& rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock2::Ready_Prototype()
{
	return S_OK;
}

HRESULT CRock2::Ready_GameObject(void* pArg)
{
...
_int CRock2::Update_GameObject(const _float& fTimeDelta)
{
	return _int();
}

_int CRock2::LastUpdate_GameObject(const _float& fTimeDelta)
{
...
HRESULT CRock2::CreateInputLayout()
{
...
CRock2* CRock2::Create()
{
	CRock2* pInstance = new CRock2();

	if (FAILED(pInstance->Ready_Prototype()))
	{
		MessageBox(0, L"CRock2 Created Failed", L"System Error", MB_OK);
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CRock2::Clone_GameObject(void* pArg, const _uint& iIdx)
{
	CRock2* pInstance = new CRock2(*this);
...
HRESULT CRock2::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CMesh*)pManagement->Clone_Component((_uint)SCENEID::SCENE_STATIC, L"Component_Static_rpg_Rock3");
