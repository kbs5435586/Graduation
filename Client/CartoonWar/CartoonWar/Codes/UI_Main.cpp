...
void CUI_Main::Render_GameObject()
{
	...
	ComPtr<ID3D12DescriptorHeap>	pOutTex = pManagement->Get_RTT((_uint)MRT::MRT_OUTLINE)->Get_RTT(0)->pRtt->GetSRV().Get();
	...
	CDevice::GetInstance()->SetTextureToShader(pOutTex.Get(), TEXTURE_REGISTER::t8);
