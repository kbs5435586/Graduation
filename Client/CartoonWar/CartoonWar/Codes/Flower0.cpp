...
CFlower0::CFlower0(const CFlower0& rhs)
	: CGameObject(rhs)
{
}

HRESULT CFlower0::Ready_Prototype()
{
	return S_OK;
}

HRESULT CFlower0::Ready_GameObject(void* pArg)
{
...
_int CFlower0::Update_GameObject(const _float& fTimeDelta)
{
	return _int();
}

_int CFlower0::LastUpdate_GameObject(const _float& fTimeDelta)
{
...
void CFlower0::Render_GameObject()
{
...
HRESULT CFlower0::CreateInputLayout()
{
...
CFlower0* CFlower0::Create()
{
	CFlower0* pInstance = new CFlower0();

	if (FAILED(pInstance->Ready_Prototype()))
	{
		MessageBox(0, L"CFlower0 Created Failed", L"System Error", MB_OK);
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CFlower0::Clone_GameObject(void* pArg, const _uint& iIdx)
{
	CFlower0* pInstance = new CFlower0(*this);
...
HRESULT CFlower0::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CMesh*)pManagement->Clone_Component((_uint)SCENEID::SCENE_STATIC, L"Component_Static_rpg_Flower1");
