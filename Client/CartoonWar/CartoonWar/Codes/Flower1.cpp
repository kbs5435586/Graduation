...
CFlower1::CFlower1(const CFlower1& rhs)
	: CGameObject(rhs)
{
}

HRESULT CFlower1::Ready_Prototype()
{
	return S_OK;
}

HRESULT CFlower1::Ready_GameObject(void* pArg)
{
...
_int CFlower1::Update_GameObject(const _float& fTimeDelta)
{
	return _int();
}

_int CFlower1::LastUpdate_GameObject(const _float& fTimeDelta)
{
...
void CFlower1::Render_GameObject()
{
...
HRESULT CFlower1::CreateInputLayout()
{
...
CFlower1* CFlower1::Create()
{
	CFlower1* pInstance = new CFlower1();

	if (FAILED(pInstance->Ready_Prototype()))
	{
		MessageBox(0, L"CFlower1 Created Failed", L"System Error", MB_OK);
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CFlower1::Clone_GameObject(void* pArg, const _uint& iIdx)
{
	CFlower1* pInstance = new CFlower1(*this);
...
HRESULT CFlower1::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CMesh*)pManagement->Clone_Component((_uint)SCENEID::SCENE_STATIC, L"Component_Static_rpg_Flower2");
