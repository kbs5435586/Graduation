...
CRock0::CRock0(const CRock0& rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock0::Ready_Prototype()
{
	return S_OK;
}

HRESULT CRock0::Ready_GameObject(void* pArg)
{
...
_int CRock0::Update_GameObject(const _float& fTimeDelta)
{
	m_pTransformCom->Scaling(0.1f, 0.1f, 0.1f);
	return _int();
}

_int CRock0::LastUpdate_GameObject(const _float& fTimeDelta)
{
...
HRESULT CRock0::CreateInputLayout()
{
...
CRock0* CRock0::Create()
{
	CRock0* pInstance = new CRock0();

	if (FAILED(pInstance->Ready_Prototype()))
	{
		MessageBox(0, L"CRock0 Created Failed", L"System Error", MB_OK);
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CRock0::Clone_GameObject(void* pArg, const _uint& iIdx)
{
	CRock0* pInstance = new CRock0(*this);
...
HRESULT CRock0::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CMesh*)pManagement->Clone_Component((_uint)SCENEID::SCENE_STATIC, L"Component_Static_rpg_Rock1");
