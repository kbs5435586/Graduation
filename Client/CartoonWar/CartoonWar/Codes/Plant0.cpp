...
CPlant0::CPlant0(const CPlant0& rhs)
	: CGameObject(rhs)
{
}

HRESULT CPlant0::Ready_Prototype()
{
	return S_OK;
}

HRESULT CPlant0::Ready_GameObject(void* pArg)
{
...
_int CPlant0::Update_GameObject(const _float& fTimeDelta)
{
	return _int();
}

_int CPlant0::LastUpdate_GameObject(const _float& fTimeDelta)
{
...
void CPlant0::Render_GameObject()
{
...
HRESULT CPlant0::CreateInputLayout()
{
...
CPlant0* CPlant0::Create()
{
	CPlant0* pInstance = new CPlant0();

	if (FAILED(pInstance->Ready_Prototype()))
	{
		MessageBox(0, L"CPlant0 Created Failed", L"System Error", MB_OK);
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CPlant0::Clone_GameObject(void* pArg, const _uint& iIdx)
{
	CPlant0* pInstance = new CPlant0(*this);
...
HRESULT CPlant0::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CMesh*)pManagement->Clone_Component((_uint)SCENEID::SCENE_STATIC, L"Component_Static_rpg_Plant1");
