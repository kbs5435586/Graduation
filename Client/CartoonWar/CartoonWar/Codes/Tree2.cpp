...
CTree2::CTree2(const CTree2& rhs)
	: CGameObject(rhs)
{
}

HRESULT CTree2::Ready_Prototype()
{
	return S_OK;
}

HRESULT CTree2::Ready_GameObject(void* pArg)
{
...
_int CTree2::Update_GameObject(const _float& fTimeDelta)
{
	return _int();
}

_int CTree2::LastUpdate_GameObject(const _float& fTimeDelta)
{
...
HRESULT CTree2::CreateInputLayout()
{
...
CTree2* CTree2::Create()
{
	CTree2* pInstance = new CTree2();

	if (FAILED(pInstance->Ready_Prototype()))
	{
		MessageBox(0, L"CTree2 Created Failed", L"System Error", MB_OK);
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CTree2::Clone_GameObject(void* pArg, const _uint& iIdx)
{
	CTree2* pInstance = new CTree2(*this);
...
HRESULT CTree2::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CMesh*)pManagement->Clone_Component((_uint)SCENEID::SCENE_STATIC, L"Component_Static_rpg_Tree3");
