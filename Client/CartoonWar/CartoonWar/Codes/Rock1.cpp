...
CRock1::CRock1(const CRock1& rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock1::Ready_Prototype()
{
	return S_OK;
}

HRESULT CRock1::Ready_GameObject(void* pArg)
{
...
_int CRock1::Update_GameObject(const _float& fTimeDelta)
{
	return _int();
}

_int CRock1::LastUpdate_GameObject(const _float& fTimeDelta)
{
...
HRESULT CRock1::CreateInputLayout()
{
...
CRock1* CRock1::Create()
{
	CRock1* pInstance = new CRock1();

	if (FAILED(pInstance->Ready_Prototype()))
	{
		MessageBox(0, L"CRock1 Created Failed", L"System Error", MB_OK);
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CRock1::Clone_GameObject(void* pArg, const _uint& iIdx)
{
...
HRESULT CRock1::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CMesh*)pManagement->Clone_Component((_uint)SCENEID::SCENE_STATIC, L"Component_Static_rpg_Rock2");
