...
COrc04::COrc04(const COrc04& rhs)
	: CGameObject(rhs)
{

}

HRESULT COrc04::Ready_Prototype()
{
	return S_OK;
}

HRESULT COrc04::Ready_GameObject(void* pArg)
{
	m_IsClone = true;
...
COrc04* COrc04::Create()
{
	COrc04* pInstance = new COrc04();

	if (FAILED(pInstance->Ready_Prototype()))
	{
		MessageBox(0, L"COrc04 Created Failed", L"System Error", MB_OK);
...
HRESULT COrc04::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
