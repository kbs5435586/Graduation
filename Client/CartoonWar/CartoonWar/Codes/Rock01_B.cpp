...
{
	CRock01_B* pInstance = new CRock01_B();

	if (FAILED(pInstance->Ready_Prototype()))
	{
		MessageBox(0, L"CRock01_B Created Failed", L"System Error", MB_OK);
...
{
	CRock01_B* pInstance = new CRock01_B(*this);
...
HRESULT CRock01_B::Ready_Component()
{
	...
	m_pMeshCom = (CMesh*)pManagement->Clone_Component((_uint)SCENEID::SCENE_STATIC, L"Component_Static_Rock01_B");
