...
CBush1::CBush1(const CBush1& rhs)
	: CGameObject(rhs)
{
}

HRESULT CBush1::Ready_Prototype()
{
	return S_OK;
}

HRESULT CBush1::Ready_GameObject(void* pArg)
{
...
_int CBush1::Update_GameObject(const _float& fTimeDelta)
{
	return _int();
}

_int CBush1::LastUpdate_GameObject(const _float& fTimeDelta)
{
...
HRESULT CBush1::CreateInputLayout()
{
...
CBush1* CBush1::Create()
{
	CBush1* pInstance = new CBush1();

	if (FAILED(pInstance->Ready_Prototype()))
	{
		MessageBox(0, L"CBush1 Created Failed", L"System Error", MB_OK);
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CBush1::Clone_GameObject(void* pArg, const _uint& iIdx)
{
	CBush1* pInstance = new CBush1(*this);
...
HRESULT CBush1::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CMesh*)pManagement->Clone_Component((_uint)SCENEID::SCENE_STATIC, L"Component_Static_rpg_Bush02");
