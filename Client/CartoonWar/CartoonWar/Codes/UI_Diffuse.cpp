...
void CUI_Diffuse::Render_GameObject()
{
	...
	ComPtr<ID3D12DescriptorHeap>	pTextureDesc = pManagement->Get_RTT((_uint)MRT::MRT_DEFFERD)->Get_RTT(3)->pRtt->GetSRV().Get();
	//ComPtr<ID3D12DescriptorHeap>	pTextureDesc = pManagement->Get_RTT((_uint)MRT::MRT_OUTLINE)->Get_RTT(0)->pRtt->GetSRV().Get();
