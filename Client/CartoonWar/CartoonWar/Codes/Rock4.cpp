...
CRock4::CRock4(const CRock4& rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock4::Ready_Prototype()
{
	return S_OK;
}

HRESULT CRock4::Ready_GameObject(void* pArg)
{
...
_int CRock4::Update_GameObject(const _float& fTimeDelta)
{
	return _int();
}

_int CRock4::LastUpdate_GameObject(const _float& fTimeDelta)
{
...
HRESULT CRock4::CreateInputLayout()
{
...
CRock4* CRock4::Create()
{
	CRock4* pInstance = new CRock4();

	if (FAILED(pInstance->Ready_Prototype()))
	{
		MessageBox(0, L"CRock4 Created Failed", L"System Error", MB_OK);
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CRock4::Clone_GameObject(void* pArg, const _uint& iIdx)
{
	CRock4* pInstance = new CRock4(*this);
...
HRESULT CRock4::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CMesh*)pManagement->Clone_Component((_uint)SCENEID::SCENE_STATIC, L"Component_Static_rpg_Rock5");
