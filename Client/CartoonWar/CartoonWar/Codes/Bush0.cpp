...
CBush0::CBush0(const CBush0& rhs)
	: CGameObject(rhs)
{
}

HRESULT CBush0::Ready_Prototype()
{
	return S_OK;
}

HRESULT CBush0::Ready_GameObject(void* pArg)
{
...
_int CBush0::Update_GameObject(const _float& fTimeDelta)
{
	return _int();
}

_int CBush0::LastUpdate_GameObject(const _float& fTimeDelta)
{
...
HRESULT CBush0::CreateInputLayout()
{
...
CBush0* CBush0::Create()
{
	CBush0* pInstance = new CBush0();

	if (FAILED(pInstance->Ready_Prototype()))
	{
		MessageBox(0, L"CBush0 Created Failed", L"System Error", MB_OK);
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CBush0::Clone_GameObject(void* pArg, const _uint& iIdx)
{
	CBush0* pInstance = new CBush0(*this);
...
HRESULT CBush0::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CMesh*)pManagement->Clone_Component((_uint)SCENEID::SCENE_STATIC, L"Component_Static_rpg_Bush01");
