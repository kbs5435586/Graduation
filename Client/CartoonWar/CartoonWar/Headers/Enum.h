...
enum class SHADER_TYPE { SHADER_FORWARD, SHADER_DEFFERED, SHADER_PARTICLE, SHADER_POST_EFFECT, SHADER_LIGHT, SHADER_COMPUTE, SHADER_END };
...
enum class CLASS { CLASS_WORKER, CLASS_CAVALRY, CLASS_INFANTRY, CLASS_SPEARMAN, CLASS_MAGE, CLASS_MMAGE, CLASS_ARCHER, CLASS_PRIEST, CLASS_END };
