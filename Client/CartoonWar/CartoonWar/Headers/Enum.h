...
enum class DATA_TYPE { DATA_INFO, DATA_MATRIX, DATA_VECTOR, DATA_INT, DATA_BOOL, DATA_INT_ARRAY, DATA_INT_WHICH, DATA_INT_PTR, DATA_END };
...
enum class MRT { MRT_SWAPCHAIN, MRT_DEFFERD, MRT_LIGHT, MRT_SHADOW, MRT_INVEN,  MRT_END };
