...
enum class DATA_TYPE { DATA_INFO, DATA_MATRIX, DATA_VECTOR, DATA_END };
...
enum class MRT {MRT_SWAPCHAIN, MRT_DEFFERD, MRT_LIGHT, MRT_INVENTORY, MRT_END};


enum class SHADER_TYPE {SHADER_FORWARD ,SHADER_DEFFERED, SHADER_PARTICLE, SHADER_POST_EFFECT, SHADER_LIGHT, SHADER_COMPUTE, SHADER_INVENTORY, SHADER_END};
