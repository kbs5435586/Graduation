...
enum class MRT { MRT_SWAPCHAIN, MRT_DEFFERD, MRT_LIGHT, MRT_SHADOW, MRT_INVEN, MRT_BLUR, MRT_OUTLINE, MRT_END };


enum class SHADER_TYPE { SHADER_FORWARD, SHADER_DEFFERED, SHADER_PARTICLE, SHADER_POST_EFFECT, SHADER_BLUR, SHADER_OUTLINE,
	SHADER_LIGHT, SHADER_SHADOW, SHADER_COMPUTE, SHADER_END };
...
enum class ANIMALS {ANIMALS_WOLF, ANIMALS_DEER, ANIMALS_END};
...
enum class ROTATE_DIR { DIR_LEFT, DIR_RIGHT, DIR_END };

enum class CHANNEL_ID { BGM, PLAYER, MONSTER, EFFECT, END };
enum class STATE {STATE_IDLE, STATE_WALK, STATE_RUN, STATE_ATTACK, STATE_ARROW, STATE_DEAD, STATE_HITTED,STATE_MAGE,  STATE_END};

enum Sound_Character { SOUND_OBJECT, SOUND_BG, SOUND_END };
enum SoundState { ATTACK, WALK, RUN, HORSE_WALK, HORSE_RUN, HIT, DIE, HITTED, IDLE, BG_STAGE, SHOOT, BG,LOGO, END };
