...
enum class MRT { MRT_SWAPCHAIN, MRT_DEFFERD, MRT_LIGHT, MRT_SHADOW, MRT_INVEN, MRT_BLUR, MRT_END };


enum class SHADER_TYPE { SHADER_FORWARD, SHADER_DEFFERED, SHADER_PARTICLE, SHADER_POST_EFFECT, SHADER_BLUR, SHADER_LIGHT, SHADER_SHADOW, SHADER_COMPUTE, SHADER_END };
