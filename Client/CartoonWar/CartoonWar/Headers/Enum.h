...
enum class DATA_TYPE { DATA_INFO, DATA_MATRIX, DATA_VECTOR, DATA_INT, DATA_BOOL, DATA_TAP, DATA_NPC, DATA_NPC_NUM, 
	DATA_WHICH, DATA_SKILL, DATA_END };
//어떻게 최소화해야 할까?
...
enum class MRT { MRT_SWAPCHAIN, MRT_DEFFERD, MRT_LIGHT, MRT_SHADOW, MRT_INVEN, MRT_BLUR, MRT_REF, MRT_END };
