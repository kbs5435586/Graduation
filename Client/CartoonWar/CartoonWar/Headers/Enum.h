...
enum class TEAM { TEAM_RED, TEAM_BLUE, TEAM_END };
...
enum class MRT { MRT_SWAPCHAIN, MRT_DEFFERD, MRT_LIGHT, MRT_SHADOW, MRT_BLUR, MRT_REF, MRT_END };


enum class SHADER_TYPE { SHADER_FORWARD, SHADER_DEFFERED, SHADER_PARTICLE, SHADER_POST_EFFECT, SHADER_BLUR, SHADER_LIGHT, SHADER_SHADOW, SHADER_COMPUTE, SHADER_REF, SHADER_END };
...
enum class ANIMALS {ANIMALS_BEAR, ANIMALS_BOAR, ANIMALS_DEER, ANIMALS_WOLF, ANIMALS_END};
enum class CHANNEL_ID { BGM, PLAYER, MONSTER, EFFECT, END };
...
enum class ENVITYPE {ENVI_FLOWER, ENVI_PLANT, ENVI_TREE, ENVI_ROCK, ENVI_END};

enum class SelectType {SELECT_INFT, SELECT_HORSE, SELECT_MAGE, SELECT_BOW, SELECT_ALL, SELECT_END};