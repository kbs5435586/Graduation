...
enum Sound_Character { SOUND_MAY, SOUND_GENG, SOUND_JUNK, SOUND_REIN, SOUND_BG, SOUND_STATIC, SOUND_END };
enum SoundState { ATTACK, SKILL_Q, SKILL_E, SKILL_SHIFT, DIE, BG_LOGO, BG_STAGE, SKILL_FLASH, HIT, END };
