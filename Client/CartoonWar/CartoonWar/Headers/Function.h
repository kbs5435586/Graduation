...
//
//float Lerp_(float a, float b, float r)
//{
//	return a + r * (b-a);
//}
...
//		XMFLOAT4X4 xmmtx4x4Result;
//		XMVECTOR d;
//		XMStoreFloat4x4(&xmmtx4x4Result, XMMatrixInverse(&d, XMLoadFloat4x4(&xmmtx4x4Matrix)));
//		return(xmmtx4x4Result);
//	}
//
...
//
//
static  int GetSizeofFormat(DXGI_FORMAT _eFormat)
{
	int iRetByte = 0;
	switch (_eFormat)
	{
