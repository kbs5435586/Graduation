...
CTempStaticMesh::CTempStaticMesh(ID3D12Device* pGraphic_Device)
	: CGameObject(pGraphic_Device)
{

}

CTempStaticMesh::CTempStaticMesh(const CTempStaticMesh& rhs)
	: CGameObject(rhs)
{

}

HRESULT CTempStaticMesh::Ready_Prototype()
{
	return S_OK;
}

HRESULT CTempStaticMesh::Ready_GameObject(void* pArg)
{
...
_int CTempStaticMesh::Update_GameObject(const _float& fTimeDelta)
{
...
_int CTempStaticMesh::LastUpdate_GameObject(const _float& fTimeDelta)
{
	if (nullptr == m_pRendererCom)
		return -1;

	if (m_pFrustumCom->Culling_Frustum(m_pTransformCom, 2.f))
	{
...
void CTempStaticMesh::Render_GameObject()
{
...
HRESULT CTempStaticMesh::CreatePipeLine(CShader* pShader)
{
...
D3D12_RASTERIZER_DESC CTempStaticMesh::CreateRaterizerState()
{
...
D3D12_DEPTH_STENCIL_DESC CTempStaticMesh::CreateDepthStencilState()
{
...
D3D12_BLEND_DESC CTempStaticMesh::CreateBlendState()
{
...
D3D12_INPUT_LAYOUT_DESC CTempStaticMesh::CreateInputLayout()
{
...
HRESULT CTempStaticMesh::Ready_Light(MAINPASS_LIGHT& tInfo)
{
...
HRESULT CTempStaticMesh::CreateConstantBuffer()
{
...
CTempStaticMesh* CTempStaticMesh::Create(ID3D12Device* pGraphic_Device)
{
	CTempStaticMesh* pInstance = new CTempStaticMesh(pGraphic_Device);
...
CGameObject* CTempStaticMesh::Clone_GameObject(void* pArg, const _uint& iIdx)
{
	CTempStaticMesh* pInstance = new CTempStaticMesh(*this);
...
HRESULT CTempStaticMesh::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	if (nullptr == pManagement)
		return E_FAIL;
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_Static_Mesh_Elf");
	...
	m_pFrustumCom = (CFrustum*)pManagement->Clone_Component(SCENE_LOGO, L"Component_Frustum");
