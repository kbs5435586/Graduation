...
CTempStaticMesh2::CTempStaticMesh2(ID3D12Device* pGraphic_Device)
	: CGameObject(pGraphic_Device)
{

}

CTempStaticMesh2::CTempStaticMesh2(const CTempStaticMesh2& rhs)
	: CGameObject(rhs)
{

}

HRESULT CTempStaticMesh2::Ready_Prototype()
{
	return S_OK;
}

HRESULT CTempStaticMesh2::Ready_GameObject(void* pArg)
{
	...
	_vec3 vPos = _vec3(60.f, 0.f, 60.f);
...
_int CTempStaticMesh2::Update_GameObject(const _float& fTimeDelta)
{
...
_int CTempStaticMesh2::LastUpdate_GameObject(const _float& fTimeDelta)
{
...
void CTempStaticMesh2::Render_GameObject()
{
...
HRESULT CTempStaticMesh2::CreatePipeLine(CShader* pShader)
{
...
D3D12_RASTERIZER_DESC CTempStaticMesh2::CreateRaterizerState()
{
...
D3D12_DEPTH_STENCIL_DESC CTempStaticMesh2::CreateDepthStencilState()
{
...
D3D12_BLEND_DESC CTempStaticMesh2::CreateBlendState()
{
...
D3D12_INPUT_LAYOUT_DESC CTempStaticMesh2::CreateInputLayout()
{
...
HRESULT CTempStaticMesh2::Ready_Light(MAINPASS_LIGHT& tInfo)
{
...
HRESULT CTempStaticMesh2::CreateConstantBuffer()
{
...
CTempStaticMesh2* CTempStaticMesh2::Create(ID3D12Device* pGraphic_Device)
{
	CTempStaticMesh2* pInstance = new CTempStaticMesh2(pGraphic_Device);
...
CGameObject* CTempStaticMesh2::Clone_GameObject(void* pArg)
{
	CTempStaticMesh2* pInstance = new CTempStaticMesh2(*this);
...
HRESULT CTempStaticMesh2::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	if (nullptr == pManagement)
		return E_FAIL;
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_Dynamic_Mesh_Test1");
	NULL_CHECK_VAL(m_pMeshCom, E_FAIL);
	if (FAILED(Add_Component(L"Com_Mesh", m_pMeshCom)))
		return E_FAIL;

	m_pTextureCom = (CTexture*)pManagement->Clone_Component(SCENE_LOGO, L"Component_Texture_Mesh_Test2");
