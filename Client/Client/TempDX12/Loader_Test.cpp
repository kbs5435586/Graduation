...
HRESULT CLoader_Test::Ready_Load_Hierachy(FbxNode* pNode)
{
	...
	/*	MeshData* pData = new MeshData(iVertices, iIndices, pIndices, vecPos);
...
HRESULT CLoader_Test::CreateBufferView(_uint iVerticesNum, _uint iIndicesNum, vector<_vec3>& vecPos, _int* pIndices, RenderInfo* pInfo)
{
