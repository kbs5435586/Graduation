...
CTexture_Terrain::CTexture_Terrain(ID3D12Device* pGraphic_Device)
	: CGameObject(pGraphic_Device)
{

}

CTexture_Terrain::CTexture_Terrain(const CTexture_Terrain& rhs)
	: CGameObject(rhs)
{

}

HRESULT CTexture_Terrain::Ready_Prototype()
{
	return S_OK;
}

HRESULT CTexture_Terrain::Ready_GameObject(void* pArg)
{
...
_int CTexture_Terrain::Update_GameObject(const _float& fTimeDelta)
{
	return _int();
}

_int CTexture_Terrain::LastUpdate_GameObject(const _float& fTimeDelta)
{
...
void CTexture_Terrain::Render_GameObject()
{
	MAINPASS tMainPass = {};
...
HRESULT CTexture_Terrain::CreatePipeLine(CShader* pShader)
{
...
D3D12_RASTERIZER_DESC CTexture_Terrain::CreateRaterizerState()
{
...
D3D12_DEPTH_STENCIL_DESC CTexture_Terrain::CreateDepthStencilState()
{
...
D3D12_BLEND_DESC CTexture_Terrain::CreateBlendState()
{
...
D3D12_INPUT_LAYOUT_DESC CTexture_Terrain::CreateInputLayout()
{
...
HRESULT CTexture_Terrain::CreateConstantBuffer()
{
...
CTexture_Terrain* CTexture_Terrain::Create(ID3D12Device* pGraphic_Device)
{
	CTexture_Terrain* pInstance = new CTexture_Terrain(pGraphic_Device);
...
HRESULT CTexture_Terrain::Ready_Component(void* pArg)
{
	...
	m_pShaderCom = (CShader*)pManagement->Clone_Component(SCENE_LOGO, L"Component_Shader_Terrain_Texture");
