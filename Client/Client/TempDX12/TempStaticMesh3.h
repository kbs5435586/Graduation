...
class CTempStaticMesh3 :
	public CGameObject
{
private:
	CTempStaticMesh3(ID3D12Device* pGraphic_Device);
	CTempStaticMesh3(const CTempStaticMesh3& rhs);
	virtual ~CTempStaticMesh3() = default;
public:
...
public:
	static CTempStaticMesh3* Create(ID3D12Device* pGraphic_Device);
