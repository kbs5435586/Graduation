...
CTempStaticMesh3::CTempStaticMesh3(ID3D12Device* pGraphic_Device)
	: CGameObject(pGraphic_Device)
{

}

CTempStaticMesh3::CTempStaticMesh3(const CTempStaticMesh3& rhs)
	: CGameObject(rhs)
{

}

HRESULT CTempStaticMesh3::Ready_Prototype()
{
	return S_OK;
}

HRESULT CTempStaticMesh3::Ready_GameObject(void* pArg)
{
	...
	_vec3 vPos = _vec3(90.f, 0.f, 90.f);
...
_int CTempStaticMesh3::LastUpdate_GameObject(const _float& fTimeDelta)
{
...
void CTempStaticMesh3::Render_GameObject()
{
...
HRESULT CTempStaticMesh3::CreatePipeLine(CShader* pShader)
{
...
D3D12_RASTERIZER_DESC CTempStaticMesh3::CreateRaterizerState()
{
...
D3D12_DEPTH_STENCIL_DESC CTempStaticMesh3::CreateDepthStencilState()
{
...
D3D12_BLEND_DESC CTempStaticMesh3::CreateBlendState()
{
...
D3D12_INPUT_LAYOUT_DESC CTempStaticMesh3::CreateInputLayout()
{
...
HRESULT CTempStaticMesh3::Ready_Light(MAINPASS_LIGHT& tInfo)
{
...
HRESULT CTempStaticMesh3::CreateConstantBuffer()
{
...
CTempStaticMesh3* CTempStaticMesh3::Create(ID3D12Device* pGraphic_Device)
{
	CTempStaticMesh3* pInstance = new CTempStaticMesh3(pGraphic_Device);
...
CGameObject* CTempStaticMesh3::Clone_GameObject(void* pArg, const _uint& iIdx)
{
	CTempStaticMesh3* pInstance = new CTempStaticMesh3(*this);
...
HRESULT CTempStaticMesh3::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	if (nullptr == pManagement)
		return E_FAIL;
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_Dynamic_Mesh_Temp3");
	NULL_CHECK_VAL(m_pMeshCom, E_FAIL);
	if (FAILED(Add_Component(L"Com_Mesh", m_pMeshCom)))
		return E_FAIL;

	m_pTextureCom = (CTexture*)pManagement->Clone_Component(SCENE_LOGO, L"Component_Texture_Mesh_Test3");
