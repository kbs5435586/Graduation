...
CTerrain::CTerrain(ID3D12Device* pGraphic_Device)
...
void CTerrain::Render_GameObject()
{
	...
	{
		CDevice::GetInstance()->GetCommandList()->SetGraphicsRootConstantBufferView(0,
...
HRESULT CTerrain::CreatePipeLine(CShader* pShader)
{
...
D3D12_RASTERIZER_DESC CTerrain::CreateRaterizerState()
{
...
D3D12_DEPTH_STENCIL_DESC CTerrain::CreateDepthStencilState()
{
...
D3D12_BLEND_DESC CTerrain::CreateBlendState()
{
...
D3D12_INPUT_LAYOUT_DESC CTerrain::CreateInputLayout()
{
...
CTerrain* CTerrain::Create(ID3D12Device* pGraphic_Device)
{
