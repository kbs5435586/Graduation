...
HRESULT CScene_Logo::Ready_Prototype_GameObject(CManagement* pManagement)
{
	...
	if (FAILED(pManagement->Add_Prototype_GameObject(L"GameObject_UI_Loading", CUI_Loading::Create())))
		return E_FAIL;
	if (FAILED(pManagement->Add_Prototype_GameObject(L"GameObject_CMyUI", CMyUI::Create())))
		return E_FAIL;
	if (FAILED(pManagement->Add_Prototype_GameObject(L"GameObject_UI_Inventory", CUI_Inventory::Create())))
		return E_FAIL;
	if (FAILED(pManagement->Add_Prototype_GameObject(L"GameObject_UI_InventoryCell", CInventory_Cell::Create())))
		return E_FAIL;
	return S_OK;
}
...
HRESULT CScene_Logo::Ready_Add_Prototype_Buffer(CManagement* pManagement)
{
	...
	if (FAILED(pManagement->Add_Prototype_Component((_uint)SCENEID::SCENE_STATIC, L"Component_Buffer_Sphere",
		...
		return E_FAIL;
	if (FAILED(pManagement->Add_Prototype_Component((_uint)SCENEID::SCENE_STATIC, L"Component_Buffer_UITex",
		CBuffer_UITex::Create())))
	return S_OK;
}
