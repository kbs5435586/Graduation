...
private:
	...
	HRESULT					Ready_Layer_Orc(const _tchar* pLayerTag, CManagement* pManagement, void* pArg);
	HRESULT					Ready_Layer_UI(const _tchar* pLayerTag, CManagement* pManagement, void* pArg, void* pSize);
public:
