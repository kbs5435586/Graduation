...
void CUI_Main::Render_GameObject()
{
	...
	_uint iOffset = pManagement->GetConstantBuffer((_uint)CONST_REGISTER::b4)->SetData((void*)&tMainPass);


	CDevice::GetInstance()->SetConstantBufferToShader(pManagement->GetConstantBuffer(0)->GetCBV().Get(), iOffset, CONST_REGISTER::b4);
