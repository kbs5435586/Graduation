...
//
//	m_ppGameObjects[2] = new CAngrybotObject(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, pfbxSdkManager, pfbxScene);
//	m_ppGameObjects[2]->SetAnimationStack(0);
//	m_ppGameObjects[2]->m_pAnimationController->SetPosition(0, 1.5f);
//	m_ppGameObjects[2]->SetPosition(0.0f, 0.0f, 350.0f);
////	m_ppGameObjects[2]->Rotate(0.0f, 270.0f, 0.0f);
